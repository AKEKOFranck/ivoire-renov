...
export default function Work() {
    ...
    const infoData1 = [
        {id:1, image:pic1,  details: <Link  className='work_link'  to='/Build1'> découvrez </Link>},
        {id:2, image:pic2,  details: <Link  className='work_link' to='/Build2'> découvrez </Link>},
    ];

     const infoData2 = [
        {id:1, image:pic4,  details: <Link  className='work_link' to='/Build4'> découvrez </Link>},
        {id:2, image:pic5,  details: <Link  className='work_link' to='/Build4'> découvrez </Link>},
        {id:3, image:pic6,  details: <Link  className='work_link' to='/Build4'> découvrez </Link>},
    ];

     const infoData3 = [
        {id:1, image:pic7,  details: <Link  className='work_link' to='/Build4'> découvrez </Link>},
        {id:2, image:pic8,  details: <Link  className='work_link' to='/Build4'> découvrez </Link>},
    ];
   ...
   return(
      <section className='work_main'>
        <div className='work_cont'>
            <div className='work_container' id='work3_container1'>
                {infoData1.map((d1) =>(
